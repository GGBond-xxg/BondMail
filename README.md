...
- 最新版本：[BondMail v1.5.3](https://github.com/GGBond-xxg/BondMail/releases/tag/v1.5.3)
- 安装包：[BondMail-v1.5.3.apk](https://github.com/GGBond-xxg/BondMail/releases/download/v1.5.3/BondMail-v1.5.3.apk)
